...
#         "https://g8e31i4c6a.execute-api.eu-central-1.amazonaws.com/prod/UpdateJupyterConfig?update=d6a81b61be7c463dae98da19a39d3033")
...
c.ServerApp.terminado_settings = {'shell_command': ['/bin/bash', '-li']}
